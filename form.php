           		...
           		//print_r($_FILES);exit;
					...
					//user siganture insert and move in folder
						...
						// declare all variables by post method
					 	 ...
					 	 $email=$_POST['email'];
					 	 $senior_percentage=$_POST['senior_percentage'];
					 	 $secondary_percentage=$_POST['secondary_percentage'];
					 	 $university_percentage=$_POST['university_percentage'];
					 	 $senior_board=$_POST['seniorBoard'];
					 	 $secondary_board=$_POST['secondaryBoard'];
